...
export default function AdminLoadingScene({
    ...
    <section className="overflow-hidden rounded-[30px] border border-[#d8e8d2] bg-[linear-gradient(180deg,#f6fbf2_0%,#eef8e8_45%,#e5f1de_100%)] p-5 shadow-[0_24px_60px_rgba(46,125,50,0.10)]">
      ...
      <div className="mt-6 rounded-[28px] border border-[#cfe2c8] bg-[linear-gradient(180deg,#eaf6e4_0%,#d9edcf_100%)] px-4 py-5 sm:px-6">
        <div className="relative h-[210px] overflow-hidden rounded-[22px] border border-[#c6ddb9] bg-[linear-gradient(180deg,#eaf7ff_0%,#f6fcff_42%,#dff0d8_42%,#cfe6c1_100%)]">
          ...
          <div className="admin-loader-track absolute bottom-[54px] left-[-120px]">
            <div className="relative h-[120px] w-[220px]">
              ...
              <div className="admin-loader-wheel absolute bottom-[18px] left-[94px] h-[26px] w-[26px] rounded-full border-[5px] border-[#2e4230] bg-[#495d49]" />
              <div className="admin-loader-wheel absolute bottom-[18px] left-[156px] h-[24px] w-[24px] rounded-full border-[4px] border-[#2e4230] bg-[#495d49]" />

              <div className="admin-loader-blade absolute bottom-[14px] left-[122px] h-[12px] w-[72px] rounded-full bg-[radial-gradient(circle,#9bd474_0_18%,transparent_19%)] opacity-75" />
            </div>
          </div>
          ...
          <div className="absolute inset-x-0 bottom-3 flex justify-center">
            <div className="rounded-full border border-white/70 bg-white/75 px-4 py-2 text-xs font-medium tracking-[0.08em] text-[#466147] shadow-sm">
              Syncing the dashboard while our groundskeeper does one clean pass.
            </div>
          </div>
        </div>
      </div>
      ...
      <style jsx>{`
        .admin-loader-track {
          animation: admin-loader-drive 5.8s linear infinite;
        }
        ...
        .admin-loader-blade {
          animation: admin-loader-blade 0.35s linear infinite;
        }

        @keyframes admin-loader-drive {
          0% {
